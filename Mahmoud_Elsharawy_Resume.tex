...
\begin{document}
    ...
    \begin{tabular}{l l l}
       Robot Learning & Reinforcement Learning & Digital System Design Using Microcontrollers \\
       Machine Learning & Advanced Computer Architecture & Embedded Operating Systems \\
    \end{tabular}\\
    ...
    %----------------------------------------------------------------------------------------
    \section{Experience}
    \subsubsection{Apple}{System Electrical Engineering Intern}{May 2024 - Aug 2024}
    \begin{itemize}
        \item Developed a software tool to automate HSPICE simulations for existing Cadence designs and GPIO specifications, using Python and shell scripts
        \item Designed a battery charging circuit and USB/SPI communication for a prototype
        \item Created prototype analog and RF circuits for testing and future development
    \end{itemize}
...
%     \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Hosted a systemd service to interact with lichess.com's API, allowing the AI to play against other bots and humans, earning an Elo rating of 1850, making it stronger than 85\% of human players on the website
    \end{itemize}
